...
PyMethodDef helloworld_funcs[] = {{"hello", (PyCFunction)hello, METH_NOARGS, hellofunc_docs}, {NULL}};
...
PyMODINIT_FUNC PyInit_helloworld(void) { return PyModule_Create(&helloworld_mod); }